...
- **Primary:** Swift, SwiftUI, Swift Concurrency, SwiftData, async/await, actors, @MainActor
- **Secondary:** Android, Kotlin, Jetpack Compose
- **Supporting:** Java, REST APIs, SQL, Git

## Selected projects

- **[MetalVisualKit](https://github.com/antonsmedberg/MetalVisualKit)** — MIT-licensed Swift package exploring GPU-first UI on iOS: a Metal-backed particle progress renderer and an ARKit LiDAR point-cloud view.
